...
Electron 剪贴板管理器：托盘常驻 + `Shift+Ctrl+X` 唤出，支持文本与图片，历史记录、置顶、分类筛选、黑白主题。

## 功能

- **唤出**：按 `Shift+Ctrl+X` 唤出粘贴板（也可点托盘图标）
...
2. **快捷键冲突**：`Shift+Ctrl+X` 若与其他应用全局快捷键冲突，唤出键可能失效。注册失败时会在控制台输出警告。
